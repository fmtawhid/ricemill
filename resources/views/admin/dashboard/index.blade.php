...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
            <a href="#" class="card widget-icon-box text-decoration-none">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="flex-grow-1 overflow-hidden">
                            ...
                            <p class="mb-0 text-muted text-truncate">
                                <span class="badge bg-danger me-1"><i class="ri-arrow-down-line"></i> 10</span>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="flex-grow-1 overflow-hidden">
                            ...
                            <h3 class="my-3">50</h3>
                            <p class="mb-0 text-muted text-truncate">
                                <span class="badge bg-success me-1"><i class="ri-arrow-up-line"></i> 20</span>
                                <span>Today</span>
                            </p>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="flex-grow-1 overflow-hidden">
                            ...
                            <h3 class="my-3">50</h3>
                            <p class="mb-0 text-muted text-truncate">
                                <span class="badge bg-success me-1"><i class="ri-arrow-up-line"></i> 10</span>
                                <span>Since last month</span>
                            </p>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
            <div class="card widget-icon-box">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="flex-grow-1 overflow-hidden">
                            <h5 class="text-muted text-uppercase fs-13 mt-0">Total Cost</h5>
                            <h3 class="my-3">৳ 30,000</h3>
                            <p class="mb-0 text-muted text-truncate">
                                <span class="badge bg-danger me-1"><i class="ri-arrow-down-line"></i> ৳ 3,000</span>
                                <span>Since last month</span>
                            </p>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
    ...
    {{--    <div class="col-xl-4 col-lg-6">
            <div class="card">
                <div class="d-flex card-header justify-content-between align-items-center">
                    ...
                    <a href="#" class="btn btn-sm btn-success">View All <i class="ri-eye-line ms-1"></i></a>
                </div>
                        ...
                        <table class="table table-sm table-centered table-hover table-borderless mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>John Doe</td>
                                    <td>1234567890</td>
                                    <td>Complaint about poor service</td>
                                </tr>
                                <tr>
                                    <td>Jane Smith</td>
                                    <td>0987654321</td>
                                    <td>Complaint about late delivery</td>
                                </tr>
                                <tr>
                                    <td>Michael Brown</td>
                                    <td>1122334455</td>
                                    <td>Complaint about damaged product</td>
                                </tr>
                                <tr>
                                    <td>Sarah Lee</td>
                                    <td>2233445566</td>
                                    <td>Complaint about rude staff</td>
                                </tr>
                                <tr>
                                    <td>David Clark</td>
                                    <td>3344556677</td>
                                    <td>Complaint about incorrect billing</td>
                                </tr>
                            </tbody>
                        </table>
                    </div> <!-- end table-responsive-->
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-centered table-hover table-borderless mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>2025-02-20</td>
                                    <td>Notice about upcoming meeting</td>
                                </tr>
                                <tr>
                                    <td>2025-02-19</td>
                                    <td>Notice about holiday schedule</td>
                                </tr>
                                <tr>
                                    <td>2025-02-18</td>
                                    <td>Notice about office renovation</td>
                                </tr>
                                <tr>
                                    <td>2025-02-17</td>
                                    <td>Notice about new policy updates</td>
                                </tr>
                                <tr>
                                    <td>2025-02-16</td>
                                    <td>Notice about staff training session</td>
                                </tr>
                            </tbody>
                        </table>
                    </div> <!-- end table-responsive-->
