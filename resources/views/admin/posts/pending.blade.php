...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <table id="pending_post_table" class="table table-striped dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Title</th>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            let table = $("#pending_post_table").DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('posts.pending') }}", // The URL for fetching the pending posts
                columns: [
